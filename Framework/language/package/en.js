...
export default{
  ...
  "输入数量":"Input quantity",
  "输入通证名称":"Enter the token name",
  "提供通证池":"Provide token pool",
  "跨链转入":"Cross-chain transfer",
  "您的dataATokenName不足,请先":"Your dataATokenName is insufficient, please",
  "您的dataATokenName不足":"Your dataATokenName is insufficient",
  "兑换比例":"Exchange ratio",
  "我的通证池": "My token pool",
  "通证池内总量": "Total amount in the token pool",
  "我的占比": "My proportion",
  "退出通证池": "Exit the token pool",
  "退出份额": "Exit share",
  "预计获得": "Expected to get",
  "包含手续费收益": "Including fee income",
  "请输入1-100的整数": "Please enter an integer from 1-100",
  "我再想想": "Think again",
  "确认退出": "Confirm",
  "请输入退出份额": "Please enter exit share",
  "您的gas费不足，无法退出，请先跨链转入。": "Your gas fee is not enough to withdraw. Please transfer in cross-chain first.",
  "兑换池退出中，预计将于1分钟内完成，为避免退出未完成造成财产损失，完成前请勿关闭app": "The redemption pool is exiting and it is expected to be completed within 1 minute. To avoid property losses caused by the incomplete exit, please do not close the app before completion",
  "申请退出兑换池额度失败，请稍后再试": "Failed to apply for withdrawal from the redemption pool quota, please try again later",
  "兑换池退出成功": "The exchange pool exited successfully",
  "兑换池退出失败，请稍后再试": "Failed to exit the redemption pool, please try again later"
}
